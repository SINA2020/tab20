		...
		if msg.content_.ID == "MessageText" then
			...
			if is_naji(msg) then
				...
				elseif text:match("^(امار)$") or text:match("^(آمار)$") then
					...
					local text = [[
<i>📈 وضعیت و آمار تبلیغ گر کانال  اورمیه📊</i>
